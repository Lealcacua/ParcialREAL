...
import proyectomundial.DAO.Iniciar_sesion;
...
public class GUIManual extends JFrame {
    ...
    private JPanel jPanelIniciar_sesion;
    private JLabel btnIniciar_sesion;
    ...
    private void initComponents() {
        ...
        jPanelIniciar_sesion = new JPanel();
        btnIniciar_sesion = new JLabel();
    ...
    private void pintarIniciar_sesion() {
        btnIniciar_sesion.setIcon(new ImageIcon(getClass().getResource("/resources/icons/dashboard_resultados.png")));
        btnIniciar_sesion.setText("Iniciar Sesión");
        btnIniciar_sesion.setForeground(new java.awt.Color(255, 255, 255));

        JLabel vacioIniciar_sesion = new JLabel();
        jPanelIniciar_sesion.setBackground(new java.awt.Color(17, 41, 63));
        jPanelIniciar_sesion.setPreferredSize((new java.awt.Dimension(220, 35)));
        jPanelIniciar_sesion.setLayout(new BorderLayout(15, 0));
        jPanelIniciar_sesion.add(vacioIniciar_sesion, BorderLayout.WEST);
        jPanelIniciar_sesion.add(btnIniciar_sesion, BorderLayout.CENTER);
        jPanelMenu.add(jPanelIniciar_sesion);

        btnIniciar_sesion.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                System.out.println("Iniciar Sesión");
                accionIniciar_sesion();
            }
        });
    }

    private void accionIniciar_sesion() {

        jLabelTop.setText("Iniciar Sesión");
        //jLabelTopDescription.setText("Bievenido al sistema de gestión de mundiales de fútbol");

        jPanelMain.removeAll();
        JPanel iniciar_sesionPanel = new JPanel();
        JLabel imageIniciar_sesion = new JLabel();

        //imageIniciar_sesion.setIcon(new ImageIcon(getClass().getResource("/resources/home.jpg"))); // NOI18N
        //imageHome.setPreferredSize(new java.awt.Dimension(810, 465));
        //iniciar_sesionPanel.add(imageIniciar_sesion);
        UsuarioField = new JTextField(50);
        UsuarioField.setPreferredSize(new Dimension(80, 40));
        ContrasenaField = new JTextField(40);
        ContrasenaField.setPreferredSize(new Dimension(80, 40));
        CargarField = new JButton("Iniciar Sesión");
        CargarField.setPreferredSize(new Dimension(150, 40));

        jPanelMain.add(new JLabel("Usuario"));
        // jPanelMain.add(iniciar_sesionPanel, BorderLayout.CENTER);
        jPanelMain.add(UsuarioField);
        jPanelMain.add(new JLabel("Contraseña"));
        jPanelMain.add(ContrasenaField);
        jPanelMain.add(CargarField);
        jPanelMain.repaint();
        jPanelMain.revalidate();

        CargarField.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                String Usuario;
                String Contrasena;
                Usuario = UsuarioField.getText();
                Contrasena = ContrasenaField.getText();
                haySesion = seleccionDAO.Validar(Usuario, Contrasena);
            }
        });
